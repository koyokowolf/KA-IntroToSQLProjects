CREATE TABLE winstons_donut_logs (id TEXT PRIMARY KEY, status TEXT, years_old INTEGER, donuts_eaten INTEGER, reason TEXT);
...
INSERT INTO winstons_donut_logs VALUES (50, "oldish adult winston lvl1", 40, 2500, "No diet");
INSERT INTO winstons_donut_logs VALUES (51, "old-ish adult winston lvl2", 41, 2500, "");
INSERT INTO winstons_donut_logs VALUES (52, "old-ish adult winston lvl3", 42, 2500, "");
INSERT INTO winstons_donut_logs VALUES (53, "old-ish adult winston lvl4", 43, 1436, "Current age");

SELECT AVG(donuts_eaten) FROM winstons_donut_logs;

SELECT * FROM winstons_donut_logs WHERE reason = "Diet" AND donuts_eaten > 150 ORDER BY donuts_eaten;

SELECT reason, SUM(donuts_eaten) AS total_donuts FROM winstons_donut_logs GROUP BY reason HAVING total_donuts > 150;
